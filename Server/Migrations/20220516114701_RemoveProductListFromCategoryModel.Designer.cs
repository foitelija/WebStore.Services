...
namespace BlazorShop.Server.Migrations
{
    ...
    [Migration("20220516114701_RemoveProductListFromCategoryModel")]
    partial class RemoveProductListFromCategoryModel
    {
            ...
            modelBuilder.Entity("BlazorShop.Shared.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            DateCreated = new DateTime(2022, 5, 16, 14, 47, 0, 849, DateTimeKind.Local).AddTicks(3637),
                        ...
                        new
                        {
                            Id = 2,
                            CategoryId = 1,
                            DateCreated = new DateTime(2022, 5, 16, 14, 47, 0, 850, DateTimeKind.Local).AddTicks(6280),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 3,
                            CategoryId = 1,
                            DateCreated = new DateTime(2022, 5, 16, 14, 47, 0, 850, DateTimeKind.Local).AddTicks(6306),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 4,
                            CategoryId = 3,
                            DateCreated = new DateTime(2022, 5, 16, 14, 47, 0, 850, DateTimeKind.Local).AddTicks(6308),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 5,
                            CategoryId = 4,
                            DateCreated = new DateTime(2022, 5, 16, 14, 47, 0, 850, DateTimeKind.Local).AddTicks(6311),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 6,
                            CategoryId = 2,
                            DateCreated = new DateTime(2022, 5, 16, 14, 47, 0, 850, DateTimeKind.Local).AddTicks(6313),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
